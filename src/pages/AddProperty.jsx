...
import "./images.css";
import { useCreatePropertyMutation } from "../store/slices/propertySlice";
...
const AddProperty = () => {
  ...
  useEffect(() => {
    if (propertyDetails === "") {
      setErrMessage("propertyDetails is required");
    }
  }, [propertyDetails]);
  ...
  const onSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      toast.success("Nouvelle propriete ajoutee");
